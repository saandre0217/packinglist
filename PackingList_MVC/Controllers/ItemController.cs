...
using PackingList_MVC.Data;
using PackingList_MVC.Models;

namespace PackingList_MVC.Controllers
{
    public class ItemController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ItemName,isPacked")] Item item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ItemName,isPacked")] Item item)
        {
            if (id != item.Id)
            {
                return NotFound();
